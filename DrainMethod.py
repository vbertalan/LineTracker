...
class LogParser:
    ...
    ## Method to transform log file to dataframe
    ...
    ## Method to generate regular expression to split log messages
    ...
    ## Method to get the list of parameters replaced by parsing 
