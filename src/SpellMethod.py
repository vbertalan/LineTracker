...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        self.df_log.to_csv(os.path.join(self.savePath, self.logname + '_Spell__structured.csv'), index=False)
        df_event.to_csv(os.path.join(self.savePath, self.logname + '_Spell__templates.csv'), index=False)
